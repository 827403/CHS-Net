...
def ICNet(nClasses=1, input_height=256, input_width=256):
    inputs = Input(shape=(input_height, input_width, 3))

    # (1/2)
    y = Lambda(lambda x: tf.compat.v1.image.resize_bilinear(x, size=(int(x.shape[1])//2, int(x.shape[2])//2)), name='data_sub2')(inputs)
